export default function Navbar() {
  return (
    <>
      <nav className="flex items-center justify-between px-4 sm:px-8 lg:px-16 py-4 sm:py-6 bg-white border-b border-slate-100">
        <div className="flex items-center gap-4 md:gap-8 lg:gap-10">
          <a aria-label="Home" href="#">
            <svg aria-hidden="true" viewBox="0 0 109 40" className="h-8 sm:h-10 w-auto">
              <path
                fillRule="evenodd"
                clipRule="evenodd"
          ...
          <ul className="hidden md:flex items-center gap-6 lg:gap-8 text-sm text-slate-700 font-normal">
        ...
        <div className="flex items-center gap-3 sm:gap-6">
          <a
            href="#"
            className="hidden sm:inline-block text-sm font-normal text-slate-700 hover:text-slate-900 transition-colors"
          >
            Sign in
          </a>
          <a
            href="#"
            className="rounded-full bg-blue-600 px-3.5 sm:px-5 py-2 sm:py-2.5 text-xs sm:text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 transition-colors whitespace-nowrap"
          >
            Get started<span className="hidden sm:inline"> today</span>
          </a>
        </div>
      </nav>
    </>
