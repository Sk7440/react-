    ...
    <>
      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-y-12 lg:grid-cols-3 lg:gap-x-8">
          {/* Feature 1: Reporting (Active/Primary) */}
          <div className="flex flex-col items-start">
            ...
            <h3 className="mt-6 text-sm font-semibold text-blue-600">
              Reporting
            </h3>
          ...
          {/* Feature 2: Inventory (Inactive/Neutral) */}
          <div className="flex flex-col items-start">
      ...
      <div className="relative overflow-hidden rounded-3xl bg-slate-100 p-8 sm:p-12 lg:p-16">
        <div className="relative mx-auto max-w-5xl overflow-hidden rounded-2xl bg-slate-900/5 p-2 ring-1 ring-inset ring-slate-900/10">
          <img
            ...
            className="w-full rounded-xl shadow-2xl ring-1 ring-slate-900/10"
          />
        </div>
      </div>
      <div className="bg-linear-to-tr from-indigo-600 via-blue-600 to-sky-400 py-20 px-4 text-center sm:py-28 sm:px-6">
        <h1 className="mx-auto max-w-4xl text-3xl font-medium tracking-tight text-white sm:text-4xl">
          Get started today
        </h1>
        ...
        <div className="mt-8 flex justify-center">
          <a
            href="#"
            className="inline-flex items-center justify-center rounded-full bg-white px-5 py-3 text-sm font-semibold text-slate-900 hover:bg-blue-50 focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white active:bg-blue-200 transition-colors"
          >
            Get 6 months free
          </a>
        </div>
